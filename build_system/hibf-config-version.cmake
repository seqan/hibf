...
# This file adds version support for `find_package(HIBF 3.1)`.
...
find_path (HIBF_CLONE_DIR
           NAMES build_system/hibf-config.cmake
           HINTS "${CMAKE_CURRENT_LIST_DIR}/..")
find_path (HIBF_INCLUDE_DIR
...
#
# If https://gitlab.kitware.com/cmake/cmake/-/issues/16716 is ever resolved, we can use HIBF_VERSION instead of
# HIBF_PROJECT_VERSION.
#
# HIBF_PROJECT_VERSION is intended to be used within `project (... VERSION "${HIBF_PROJECT_VERSION}")`.
set (HIBF_PROJECT_VERSION "${PACKAGE_VERSION}")
if (HIBF_RELEASE_CANDIDATE_VERSION VERSION_GREATER "0")
    set (PACKAGE_VERSION "${PACKAGE_VERSION}-rc.${HIBF_RELEASE_CANDIDATE_VERSION}")
endif ()

if (NOT HIBF_PROJECT_VERSION VERSION_EQUAL PACKAGE_VERSION)
    ...
    message (AUTHOR_WARNING "HIBF_PROJECT_VERSION and HIBF_VERSION mismatch, "
