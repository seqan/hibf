...
concept compatible_joinable_ranges =
    ...
    && ::std::common_reference_with<::std::ranges::range_rvalue_reference_t<R>,
    ...
    using iterator_category = ::std::conditional_t<
        ...
        ::std::conditional_t<
            ::std::derived_from<::std::bidirectional_iterator_tag,
                                typename ::std::iterator_traits<OuterIter>::iterator_category> && ::std::
                derived_from<::std::bidirectional_iterator_tag,
                             typename ::std::iterator_traits<InnerIter>::iterator_category> && ::std::
                    derived_from<::std::bidirectional_iterator_tag,
                                 typename ::std::iterator_traits<PatternIter>::iterator_category> && ::std::ranges::
                        common_range<InnerBase> && ::std::ranges::common_range<PatternBase>,
            ::std::bidirectional_iterator_tag,
            ::std::conditional_t<
                ::std::derived_from<::std::forward_iterator_tag,
                                    typename ::std::iterator_traits<OuterIter>::iterator_category> && ::std::
                    derived_from<::std::forward_iterator_tag,
                                 typename ::std::iterator_traits<InnerIter>::iterator_category> && ::std::
                        derived_from<::std::forward_iterator_tag,
...
public:
    ...
    {
        using rvalue_reference = ::std::common_reference_t<::std::iter_rvalue_reference_t<InnerIter>,
