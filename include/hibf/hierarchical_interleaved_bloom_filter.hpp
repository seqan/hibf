...
public:
    ...
    */
    ...
    using ibf_t = hibf::interleaved_bloom_filter;
...
hierarchical_interleaved_bloom_filter::membership_agent_type
...
hibf::layout::layout hierarchical_interleaved_bloom_filter::compute_layout(config const & hibf_config)
{
...
void hierarchical_interleaved_bloom_filter::build_index(config const & hibf_config, hibf::layout::layout & hibf_layout)
{
...
size_t
hierarchical_interleaved_bloom_filter::hierarchical_build(robin_hood::unordered_flat_set<uint64_t> & parent_kmers,
                                                          lemon::ListDigraph::Node const & current_node,
                                                          build_data & data,
                                                          bool is_root)
{
...
size_t hierarchical_interleaved_bloom_filter::hierarchical_build(lemon::ListDigraph::Node const & root_node,
                                                                 build_data & data)
{
