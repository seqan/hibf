 ...
 */
struct writer_count : public hibf::detail::strong_type<size_t, writer_count>
{
    //!\brief An alias for the base type.
    using base_t = hibf::detail::strong_type<size_t, writer_count>;
 ...
 * \ingroup utility_parallel
 */
struct reader_count : public hibf::detail::strong_type<size_t, reader_count>
{
    //!\brief An alias for the base type.
    using base_t = hibf::detail::strong_type<size_t, reader_count>;
