...
TEST(hibf_test, test_specific_hash_values)
{
    ...
    std::vector<std::vector<std::vector<size_t>>> hashes{{{1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u}},
                                                         {{1u, 2u, 3u, 4u, 5u}}};

    hibf::hibf_config config{.input = hashes, .rearrange_user_bins = false};
