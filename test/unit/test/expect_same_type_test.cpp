...
{
    auto && expect_result = seqan::hibf::test::expect_same_type{}("std::type_identity< decltype(0)>{}",
...
TEST(int_ref, same_type_pass)
{
    int a{};
    int & i = a;
    auto && expect_result = seqan::hibf::test::expect_same_type{}("std::type_identity< decltype(i)>{}",
                                                                  "std::type_identity< int &>{}",
