...
include (library_template_path_longest_stem)

# Get a specific component of a test file which follows the library_template naming scheme.
...
macro (library_template_test_component VAR target_source_file component_name_)
    string (TOUPPER "${component_name_}" component_name)

    get_filename_component (target_relative_path "${target_source_file}" DIRECTORY)
    library_template_path_longest_stem (target_name "${target_source_file}")
