...
# Example:
#
# hibf_macro_benchmark(
#     edit_distance_macro_benchmark.cpp
#     REPETITIONS 3 # optional, default value is 3
#     META_DATA # optional
#         foo bar # user-specified data
#         hibf_version 3.0.1 # automatically set
#         hibf_git_version a1829272d7bafea48580af6eaac2bfbb678c3861 # automatically set
...
function (hibf_macro_benchmark macro_benchmark_cpp)
    ...
    hibf_test_component (target "${macro_benchmark}" TARGET_NAME)
    hibf_test_component (test_name "${macro_benchmark}" TEST_NAME)
