...
# Get a specific component of a test file which follows the hibf naming scheme.
...
macro (hibf_test_component VAR target_source_file component_name_)
    string (TOUPPER "${component_name_}" component_name)

    get_filename_component (target_relative_path "${target_source_file}" DIRECTORY)
    hibf_path_longest_stem (target_name "${target_source_file}")
