...
set (library_template_test_snippets
     ""
     CACHE STRING "" FORCE)

include ("${CMAKE_CURRENT_LIST_DIR}/../library_template_path_longest_stem.cmake")
include ("${CMAKE_CURRENT_LIST_DIR}/../library_template_test_files.cmake")
...
function (collect_used_snippet target)
    set (library_template_test_snippets
         "${library_template_test_snippets};${target}"
         CACHE STRING "" FORCE)
endfunction ()
...
function (list_unused_snippets snippet_base_path)
    library_template_test_files (test_snippet_output_glob_list "${snippet_base_path}" "*.out;*.err")
    set (test_snippet_output_list "")

    # get the source location of each "used" test target and collect it.
    foreach (test_target ${library_template_test_snippets})
        # e.g. /library_template/test/snippet/../../doc/tutorial/08_pairwise_alignment/configurations.cpp
        get_target_property (source "${test_target}" SOURCES)
        # e.g. configurations
        library_template_path_longest_stem (source_wle "${source}")
        # e.g. /library_template/test/snippet/../../doc/tutorial/pairwise_alignment
