...
#
# Example:
# library_template_generate_snippet("<..>/@target_alphabet@_implicit_conversion_from_@source_alphabet@.cpp.in"
...
function (library_template_generate_snippet source_snippet)
    if (NOT LIBRARY_TEMPLATE_CLONE_DIR)
        message (AUTHOR_WARNING "library_template_generate_snippet can't be used if "
                                "LIBRARY_TEMPLATE_CLONE_DIR (i.e. no git checkout) is not defined.")
        return ()
    endif ()
    ...
    configure_file ("${LIBRARY_TEMPLATE_CLONE_DIR}/${source_snippet}" "${LIBRARY_TEMPLATE_CLONE_DIR}/${target_snippet}")
endfunction ()
