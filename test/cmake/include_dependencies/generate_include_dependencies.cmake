...
function (generate_include_dependencies_impl)
    cmake_parse_arguments (
        "" #
        "" #
        "TARGET;TARGET_INTERNAL_DEPENDENCY_MAKE_FILE;LIBRARY_TEMPLATE_INCLUDE_DIR;TARGET_DEPENDENCIES_FILE" #
    ...
    #  /library_template/include/library_template/core/platform.hpp \
    #  /library_template/include/library_template/std/algorithm \
    # ```
    ...
    # only use lines that contain a library_template include
    list (FILTER header_files INCLUDE REGEX "${_LIBRARY_TEMPLATE_INCLUDE_DIR}/library_template")

    # filter out object files, e.g., discard "utility/views/CMakeFiles/zip_test.dir/zip_test.cpp.o: " in the line
    # `utility/views/CMakeFiles/zip_test.dir/zip_test.cpp.o: /library_template/include/library_template/core/platform.hpp`
    ...
    if (NOT header_files)
        ...
        # 2. The header does not contain any library_template include.
        message (AUTHOR_WARNING "no library_template header files contained: ${_TARGET_INTERNAL_DEPENDENCY_MAKE_FILE}\n"
    ...
    foreach (header_file ${header_files})
        ...
        file (RELATIVE_PATH relative_header_file "${_LIBRARY_TEMPLATE_INCLUDE_DIR}/library_template" "${header_file}")
...
if (CMAKE_SCRIPT_MODE_FILE)
    ...
    generate_include_dependencies_impl (
        ...
        TARGET_INTERNAL_DEPENDENCY_MAKE_FILE
            "${TARGET_INTERNAL_DEPENDENCY_MAKE_FILE}"
            # e.g. /library_template-repo/include
            LIBRARY_TEMPLATE_INCLUDE_DIR "${LIBRARY_TEMPLATE_INCLUDE_DIR}"
