...
include (${LIBRARY_TEMPLATE_INCLUDE_DIR}/../test/cmake/library_template_test_files.cmake)
...
#
# Example:
# replace_in_doxygen_layout ("${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/about/" "About")
#
# (1) Find all 'index.md' files in ${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/about/
# (2) For each 'index.md'
...
# For example,
# replace_in_doxygen_layout ("${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/setup/" "Setup" HIDE_FROM_USER "setup_tests")
...
function (replace_in_doxygen_layout doc_path doxygen_layout_tag)
    ...
    library_template_test_files (doc_how_to_filenames "${doc_path}" "index.md")
    foreach (doc_how_to_filename ${doc_how_to_filenames})
        ...
        if ("${doc_ref_name}" IN_LIST ARGS_HIDE_FROM_USER)
            set (visibility "\${LIBRARY_TEMPLATE_SHOW_DEV_DOCS}")
        endif ()
        string (APPEND
...
file (READ "${LIBRARY_TEMPLATE_DOXYGEN_INPUT_DIR}/DoxygenLayout.xml" DOXYGEN_LAYOUT)

replace_in_doxygen_layout ("${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/about/" "About")
replace_in_doxygen_layout ("${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/setup/" "Setup" HIDE_FROM_USER "setup_tests")
replace_in_doxygen_layout ("${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/tutorial/" "Tutorial")
replace_in_doxygen_layout ("${LIBRARY_TEMPLATE_INCLUDE_DIR}/../doc/howto/" "How-To")
