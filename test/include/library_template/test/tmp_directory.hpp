 ...
 *
 * Define some helper classes and functions for the tests, that would be misplaced in the library_template/include directory.
 */
...
public:
     ...
     * \return library_template::test::sandboxed_path containing the path of the file.
     */
