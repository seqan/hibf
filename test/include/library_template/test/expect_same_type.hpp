...
#include <library_template/test/type_name_as_string.hpp>
...
#define EXPECT_SAME_TYPE(val1, val2)                                                                                   \
    EXPECT_PRED_FORMAT2(::library_template::test::expect_same_type{},                                                  \
...
struct expect_same_type
{
                                          ...
                                          std::type_identity<rhs_t>)
    {
        ...
        return ::testing::internal::CmpHelperEQFailure(remove_wrap_type_identity(lhs_expression).c_str(),
                                                       ...
                                                       library_template::detail::type_name_as_string<lhs_t>,
                                                       library_template::detail::type_name_as_string<rhs_t>);
    }
};
