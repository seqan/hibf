...
/*!\file
 * \brief Provides library_template::test::sandboxed_path and related free functions.
 ...
 *
 * library_template::sandboxed_path provides the same functionality as std::filesystem::path, but restricts
 ...
 *
 *  Invariant:
 *  - library_template::sandboxed_path is always converted to an absolute path
 *  - library_template::sandboxed_path always points to a file or directory inside a given sandbox directory
...
/*!\brief Append a path to a library_template::test::sanboxed_path.
 * \tparam path_t The type of the path to append.
 * \param lhs The library_template::test::sandboxed_path.
 * \param rhs The path to append.
 * \relates library_template::test::sandboxed_path *
 *
