...
Go to https://github.com/seqan/Hierarchical_Interleaved_Bloomfilter/issues and check if someone else has already reported the same issue. If not,
...
must conform to our [style guide](https://github.com/seqan/Hierarchical_Interleaved_Bloomfilter/wiki#library-coding-guide). In the future we hope
